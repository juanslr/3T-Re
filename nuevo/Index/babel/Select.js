...
document.addEventListener("DOMContentLoaded", function () {
    var formularioAjaxMYSQL = document.getElementById("formularioMYSQL");
    formularioAjaxMYSQL.addEventListener("submit", function (event) {
        event.preventDefault();
        realizarPeticionAsincronaMYSQL();
    });

    var formularioAjaxPDO = document.getElementById("formularioPDO");
...
function realizarPeticionAsincronaBusqueda() {
    ...
    }).then(escribirResultado).catch(function (error) {
        console.error(error);
...
function asociarEventoSelectPrueba() {
    var selectCampo = document.getElementById("prueba");
    selectCampo.addEventListener("change", function (event) {
